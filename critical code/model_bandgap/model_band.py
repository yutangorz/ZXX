...
TRAIN_PATH = r"train_features_b.csv"
TEST_PATH = r"test_features_b.csv"
TARGET_COL = 'target'
...
def train_and_predict():
    ...
    model_pkl_path = output_dir / "lightgbm_model_b.pkl"
    try:
        ...
        print(f"Error: {e}")
        try:
            fallback_path = Path("lightgbm_model_b.pkl").absolute()
